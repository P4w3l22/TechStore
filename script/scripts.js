...
function addProd(id=-1)
{
    if (prod_valid())
    {
        ...
        if (select.value !== '...') {
            destination_url = '../actions_php/Edit.php?m=p'
            ...
            if (id !== -1) {
                destination_url = '../actions_php/Edit.php?id=' + id.toString() + "&m=p"
...
function saveOrder(id, prev_id, edit_or_del)
{
    ...
    destination_url = '../actions_php/Edit.php?m=o'
    alert_message = 'Zmieniono!'
...
function save(id)
{
    ...
    destination_url = "../actions_php/Edit.php?m=c"
    alert_message = "Zmieniono"
