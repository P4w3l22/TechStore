                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" style="text-align: left;">
                    ...
                    <div style="display: flex; flex-direction: row;">
                        ...
                        <?php if (isset($_SESSION['username'])) : ?>
                            <a href="actions/class/SessionDestroy.php" style="display: flex; justify-content: center; align-items: center; color: blueviolet;" title="Wyloguj">
                        ...
                        <?php else : ?>
                            <a href="log/login.html" style="display: flex; justify-content: center; align-items: center; color: white;" title="Zaloguj">
