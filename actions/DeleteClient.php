...
<div class="row-md-10 m-5">
    <h3 class="mb-5">Wybierz klienta, którego chcesz usunąć
    ...
    <form action="DeleteClient.php" method="post">
        <table class="table">
            ...
            <tbody>
                <?php $manage -> CheckedList(); ?>
            </tbody>
        </table>
        <label></label>
        <input class="submit_button" type="submit" style="margin: 19px 15px;" value="Usuń">
    </form>
</div>
